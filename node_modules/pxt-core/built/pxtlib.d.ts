...
declare namespace ts.pxtc.Util {
    ...
    function updateLocalizationAsync(targetId: string, simulator: boolean, baseUrl: string, code: string, pxtBranch: string, targetBranch: string, live?: boolean, force?: boolean): Promise<void>;
...
declare namespace pxt.cpp {
    ...
    function matchTargetId(data: pxt.cpp.HexFile, id: string): boolean;
